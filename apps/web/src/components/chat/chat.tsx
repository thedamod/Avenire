...
/**
 * Renders a multimodal chat UI with message streaming, file attachments, drag-and-drop upload, and model selection.
 *
 * @param id - Chat identifier used to initialize and resume the chat session
 * @param initialMessages - Initial list of messages to populate the conversation
 * @param selectedModel - Primary model name used for generating responses
 * @param selectedReasoningModel - Optional reasoning model name used for specialized reasoning responses
 * @param isReadonly - When true, hides the composer and prevents sending new messages
 * @returns The React element tree for the chat interface, including messages list, composer, attachment handling, and drag-and-drop overlay
 */
