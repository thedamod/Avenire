...
/**
 * Renders a full-featured PDF viewer UI for the given PDF source.
 *
 * Renders toolbar controls (thumbnails toggle, page navigation, zoom, print, download),
 * a toggleable thumbnail panel, and the main page rendering area with canvas, text, and annotation layers.
 *
 * @param source - The PDF file location (URL or blob URL) to load and display.
 * @returns A JSX element containing the PDF viewer and its controls.
 */
...
/**
 * Renders a styled PDF viewer component for the provided PDF source.
 *
 * @param source - URL or string source of the PDF to display
 * @param className - Optional additional CSS class names applied to the viewer root
 * @returns A JSX element containing the PDF viewer UI
 */
function PDFViewer({
  source,
  className,
